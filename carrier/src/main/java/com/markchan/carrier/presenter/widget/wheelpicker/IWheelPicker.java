...
public interface IWheelPicker {
     ...
     * {@link com.markchan.carrier.presenter.widget.wheelpicker.WheelPicker.OnItemSelectedListener}回调监听或调用
     ...
     * 前所根据这些参数改变的一些属性，比如
     * {@link com.markchan.carrier.presenter.widget.wheelpicker.WheelPicker.OnWheelChangeListener}和
     * {@link com.markchan.carrier.presenter.widget.wheelpicker.WheelPicker.OnItemSelectedListener}监听器中方法参数的值，因
     * 此你总该在调用该方法后考虑到相关影响
     ...
     * {@link com.markchan.carrier.presenter.widget.wheelpicker.WheelPicker.OnWheelChangeListener} and
     * {@link com.markchan.carrier.presenter.widget.wheelpicker.WheelPicker.OnItemSelectedListener}, so you must always
     ...
     * @see com.markchan.carrier.presenter.widget.wheelpicker.WheelPicker.OnWheelChangeListener
     */
